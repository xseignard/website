  ...
  <div class="page about">
    ...
    <div class="about--content">
      <div class="about--content--left">
        ...
        />
        <div
          v-scroll="{ class: 'visible', threshold: 0.4 }"
          v-html="about.about_intro"
        />
      </div>
      <div class="about--content--right">
        <div class="about--content--right--domains">
          <p v-scroll="{ class: 'visible', threshold: 0.4 }">
            Web<br />development
          </p>
          <svg
            v-scroll="{ class: 'visible', threshold: 0.4 }"
        ...
        <div
          class="about--content--right--img"
          :style="`background-image: url(${about.picture.url})`"
        >
          <svg
